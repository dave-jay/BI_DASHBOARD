        ...
        <div class="col-md-12 col-lg-12 ">
            ...
            <div class="panel panel-default ">
                <div class="panel-heading">
                    <div style=""><b>List of Asana</b></div>
                    ...
                    if (!empty($asana)):
                        ...
                        <form method="post" action="users" class="form-horizontal" role="form" >
                            <table class="table table-hover" id="example">
                                ...
                                <tbody id="">
                                    <?php foreach ($asana as $each_data): ?>
            <!--                                <tr><td>
                                                    <input type="checkbox" class="delete" name="delete[]" value="<?php print $each_data['id']; ?>"  id="delete[]"/>
            
                                                </td>-->
                                    <td><?php print $cr; ?></td>
                                    <td><?php print $each_data['asana_key']; ?></td>
                                    

                                    <td>
                                        <a href="<?php print _U ?>asana/edit/<?php print $each_data['id']; ?>"><i class="glyphicon glyphicon-edit" title="Edit"></i></a>
                                        <a href="javascript:void(0);" onclick="return DeleteUser('asana/delete/<?php print $each_data['id']; ?>')"><i class="glyphicon glyphicon-trash" title="Delete"></i></a>
                                    </td>
                                    </tr>
                                    <?php $cr++; ?>    
                                <?php endforeach; ?>
